var App = React.createClass({
	...
	update: function (){
		this.setState({
			//if there is no wrapper (div) cover the input element
			//we only use this.refs.red.getDOMNode().value
...
var Slider = React.createClass({
	render: function () {
		return (
			<div>
				<input ref="inp" type="range" min="0" max="255" placeholder="enter the value" onChange={this.props.update} />
			</div>
			);
	}
});
